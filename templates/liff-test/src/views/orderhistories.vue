  ...
  <form v-on:submit.prevent="onUpdate">
    <dl>
      <div
        ...
        <dt v-if="orderhistories.control_items.order_id==constvalue['DISP_ONLY']">■注文番号&nbsp;</dt>
        <dd v-if="orderhistories.control_items.order_id==constvalue['DISP_ONLY']">&nbsp;&nbsp;{{orderhistory.order_id}}</dd>
        <dt v-if="orderhistories.control_items.order_regist_day==constvalue['DISP_ONLY']">■注文日&nbsp;</dt>
        ...
        <dt v-if="orderhistories.control_items.order_amount==constvalue['DISP_ONLY']">■ご注文金額&nbsp;</dt>
        <dd v-if="orderhistories.control_items.order_amount==constvalue['DISP_ONLY']">&nbsp;&nbsp;{{orderhistory.order_amount}}</dd>
        <dt v-if="orderhistories.control_items.shipment_detail_status==constvalue['DISP_ONLY']">■ご注文の状態&nbsp;</dt>
        <dd v-if="orderhistories.control_items.shipment_detail_status==constvalue['DISP_ONLY']">&nbsp;&nbsp;{{orderhistory.shipment_detail_status}}</dd>
      </div>
    </dl>
  </form>
</template>